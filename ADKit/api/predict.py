...
def load_data(datacsv):
  ...
  data=np.loadtxt(path_temp + "suffle_alldata.csv",delimiter=",")
  ...
  norm_test = D_x[-1,:]
  # np.savetxt(path_temp + "norm_test.csv", D_x[-1,:], delimiter =",") # normalised
  # #print(norm_test.shape)
  # # mlp output

  tr_w1 = np.loadtxt(path_temp + "trl_wt1_mlp.csv", delimiter=",")
  tr_w2 = np.loadtxt(path_temp + "trl_wt2_mlp.csv", delimiter=",")
  tr_w3 = np.loadtxt(path_temp + "trl_wt3_mlp.csv", delimiter=",")
  tr_w4 = np.loadtxt(path_temp + "trl_wt4_mlp.csv", delimiter=",")

  tr_b1 = np.loadtxt(path_temp + "trl_bias1_mlp.csv", delimiter=",")
  tr_b2 = np.loadtxt(path_temp + "trl_bias2_mlp.csv", delimiter=",")
  tr_b3 = np.loadtxt(path_temp + "trl_bias3_mlp.csv", delimiter=",")
  tr_b4 = np.loadtxt(path_temp + "trl_bias4_mlp.csv", delimiter=",")
  ...
  pred_svr = settings.MODEL_OBJ.predictclf(test)
  pred_gbr = settings.MODEL_OBJ.predictgbr(test)
  pred_lgb = settings.MODEL_OBJ.predictlgb(test)
  pred_bay = settings.MODEL_OBJ.predictbay(test)
  pred_elc = settings.MODEL_OBJ.predictelc(test)
  ...
  train_regr = np.loadtxt(path_temp + "regr5_merge_train.csv", delimiter = ",")
  ...
  sn_w1 = np.loadtxt(path_temp + "sn_wt1_5reg_mlp.csv", delimiter=",")
  sn_w2 = np.loadtxt(path_temp + "sn_wt2_5reg_mlp.csv", delimiter=",")

  sn_b1 = np.loadtxt(path_temp + "sn_bias1_5reg_mlp.csv", delimiter=",")
  sn_b2 = np.loadtxt(path_temp + "sn_bias2_5reg_mlp.csv", delimiter=",")
