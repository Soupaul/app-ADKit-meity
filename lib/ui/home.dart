...
Future _takePhoto() async {
 ...
 Future _uploadPhoto() async {
              ...
              StorageReference firebaseStorageRef = FirebaseStorage.instance.ref().child('VideoG'+new DateTime.now().millisecondsSinceEpoch.toString());
  ...
  Future _uploadVideo() async {
              ...
              StorageReference firebaseStorageRef = FirebaseStorage.instance.ref().child('VideoR'+new DateTime.now().millisecondsSinceEpoch.toString());
              ...
              child: Container(
                child: SizedBox.expand(
                  child: RaisedButton(
                    ...
                    child: currentImage == null ? Text(firstButtonText,style: TextStyle(
                          fontSize: textSize, color: Colors.white)): enableUploadImage(),
                  ),
                ),
              ),
            ),
            Flexible(
              child: Container(
                ...
                child: RaisedButton(
                  ...
                  child: currentVideo == null ? Text(secondButtonText,style: TextStyle(
                          fontSize: textSize, color: Colors.blueGrey)): enableUploadVideo(),
                ),
              )),
              flex: 1,
            ),
